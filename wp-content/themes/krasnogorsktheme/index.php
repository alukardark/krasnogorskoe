...
<!--     <div id="bgndVideo" class="player"
         data-property="{
        videoURL:'http://www.youtube.com/watch?v=yYd_d34g-As',
        containment:'header',
        autoPlay:true,
        mute:true,
        startAt:0,
                    ...
                    foreach( $myposts as $post ){
                        ...
                        if($products_cat==$item_cat_key):
                            ...
                            <li class="product-el">
                                ...
                                <div class="btn-order"><div class="button-bubble" data-id="<?=$post->ID?>" data-toggle="modal" data-target="#modal-order">Заказать</div></div>
                            </li>
                        <?endif;?>
                    <?}wp_reset_postdata();?>
                </ul>
    ...
    >
        ...
        <div class="get-catalog-form clearfix">
            <?echo do_shortcode("[contact-form-7 id=\"218\" title=\"Получить каталог\"]");?>
        </div>
    ...
    <div class="production">
        ...
        <div class="wrapper">
            ...
            >
                ...
                foreach( $myposts as $post ){
                    ...
                    <li class="production-element">
                        <a data-text="<?=get_field('video-text');?>" data-toggle="modal" data-target="#modal-video" href="#" class="production-img" style="background-image: url(<?=get_field('video-img');?>)"></a>
                        <p><?the_title()?></p>
                    </li>
                <?}wp_reset_postdata();?>
            </ul>
            ...
            <a class="watch-video" data-toggle="modal" data-target="#modal-video" href="#"
               data-aos="fade-in"
               data-aos-offset="-200"
               data-aos-easing="ease-in-out"
               data-aos-duration="1000"
    ...
    <div class="calc wrapper" id="calc">
        ...
        <div  data-aos="fade-in"
            ...
            <div class="min-calc-info-wrap">
                ...
                <div class="calc-info-desc">Одной бутылки воды вам хватит на <span>3</span> дн.</div>
            </div>

            <div class="min-calc-info-wrap">
                <!--<div class="calc-btn" data-toggle="modal" data-target="#modal-order">Заказать</div> -->
                <div class="calc-btn" data-recommended-id="<?=get_field('recommended_product', 12)?>">Заказать</div>
                <div class="calc-info-desc min-calc-info-desc">Одной бутылки воды вам хватит на <span>3</span> дн.</div>
            </div>
        ...
        <div class="wrapper">
            ...
            <div class="contacts-wrap">
                <ul class="contacts-phone"
                    ...
                    endforeach;
                    ?>
                    <li><a href="viber://chat?number=<?=get_field('contacts-viber', 12);?>"><?=get_field('contacts-viber', 12);?>(viber)</a></li>
                </ul>
            ...
            <div  data-aos="fade-in"
                  ...
                  data-aos-duration="750"
                  data-aos-delay="250">
                <?echo do_shortcode("[contact-form-7 id=\"221\" title=\"Остались вопросы\" html_class=\"callback\"]");?>
